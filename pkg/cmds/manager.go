...
func NewCmdManager() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:               "manager",
		Short:             "Launch cluster profile manager",
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "d68cc945.k8s.appscode.com",
			...
			if err = (&controller.ManagedClusterSetProfileReconciler{
				Client: mgr.GetClient(),
				Scheme: mgr.GetScheme(),
			}).SetupWithManager(mgr); err != nil {
				setupLog.Error(err, "unable to create controller", "controller", "ManagedClusterSetProfile")
				os.Exit(1)
			}
			if err = (&controller.ManagedClusterProfileBindingReconciler{
				Client: mgr.GetClient(),
				Scheme: mgr.GetScheme(),
			}).SetupWithManager(mgr); err != nil {
				setupLog.Error(err, "unable to create controller", "controller", "ManagedClusterProfileBinding")
				os.Exit(1)
			}
